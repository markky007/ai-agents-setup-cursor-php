...
description: Animation and micro-interaction decisions (duration, easing, when not to animate). Read when the user asks for motion/"feel", or frontend-implementation-specialist routes here. Skip ordinary UI without motion work.
---
